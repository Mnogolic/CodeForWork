...
data = pd.read_excel(r'C:\Users\kasja\PycharmProjects\CodeForWork\DB_MAR\Мармелад.xlsx', skiprows=13)
...
additional_stop_words = {
    ...
    "наш", "энэкт", "день", "магазин", "покупатель", "комментарий", "недостаток", "вкус", "мармелад",
    "мнение", "бренд", "достоинство", "мармеладка", "упаковка", "общество", "ответственность", "юнэкт",
    "юниона", "ооо", "прийти", "мочь", "артикул", "казахстан", "мелла", "свой", "перфетти", "владимирович", "который",
    "пачка", "индивидуальный", "вид", "предприниматель", "ольга", "видеть", "ваш", "это", "самый", "срок", "россия",
    "год",
    "слапогузов"
}
